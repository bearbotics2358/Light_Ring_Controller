...
Change Activity:
  ...
  3/29/14 BD - removed cyz references
  - added slaveAddress variable and setting in init
  - use global variable for address (was part of a struct before)
  2/11/15 
...
/*
moved to .h file so can monitor from main
